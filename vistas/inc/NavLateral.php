<section class="full-box nav-lateral">
    ...
    <div class="full-box nav-lateral-content">
        <figure class="full-box nav-lateral-avatar">
            ...
            <img src="<?php echo SERVERURL; ?>vistas/assets/avatar/Avatar-2.jpg" class="img-fluid" alt="Avatar">
            <figcaption class="roboto-medium text-center">
                Daniel Canaviri <br><small class="roboto-condensed-light">Web Developer</small>
            </figcaption>
        </figure>
